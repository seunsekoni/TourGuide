...
public class LagosPlacesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LagosAdapter tourAdapter = new LagosAdapter(this, tours, R.color.colorGreen);
...
//    public String reduceString(String word) {
//        String truncWord ="";
//        if (word.length() > 50) {
//            truncWord = word.substring(0, 50) +"Read more...";
//        }
//        return truncWord;
//    }
